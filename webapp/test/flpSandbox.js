		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#localdataprojectlocaldatacrudoperationproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"localdataprojectlocaldatacrudoperationproject-display": {
								"semanticObject": "localdataprojectlocaldatacrudoperationproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=localdataproject.localdatacrudoperationproject",
									"url": sap.ui.require.toUrl("localdataproject/localdatacrudoperationproject")
								}
							}
						}
					}
